if __name__ == '__main__':
	with open('prepopulate.sql', 'w') as outfile:
		...
		for i in range(20):
			q1 = 'INSERT INTO Textbook (ISBN, Title, Subject, Author, Edition) VALUES ("' + str(i) + '", "Title' + str(i) + '", "Subject' + str(i) + '", "Author' + str(i) + '", ' + str(i) + ');\n'
			outfile.write(q1)

		outfile.write('\n')

		for i in range(20):
			q1 = 'INSERT INTO VendorArchive (Vendor_ID, ISBN, Price) VALUES (' + str(i + 1) + ', "' + str(i) + '", 50.0);\n'
			outfile.write(q1)
		...
		for i in range(20):
			q1 = 'INSERT INTO Transaction (Vendor_ID, Customer_ID, ISBN, Purchase_Date, Price) VALUES (' + str(i + 1) + ', ' + str(i + 1) + ', ' + str(i) + ', "2017-03-05", 50.0);\n'
			outfile.write(q1)
